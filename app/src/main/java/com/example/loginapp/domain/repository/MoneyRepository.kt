...
interface MoneyRepository {
    ...
    suspend fun insertTransaction(transaction: MoneyTransaction): Result<Unit>
    suspend fun updateTransaction(transaction: MoneyTransaction): Result<Unit>
    suspend fun deleteTransaction(transaction: MoneyTransaction): Result<Unit>
